...
INSERT INTO `evaluation` VALUES (1,1),(2,2);

INSERT INTO `evaluation_accueil_criteres_notes` VALUES (1,10,'Espace de travail'),(1,5,'Matériel'),(1,20,'Propreté');

INSERT INTO `evaluation_contenu_criteres_notes` VALUES (1,10,'L\'atteinte des objectifs de la formation'),(1,20,'L\'intérêt du sujet de formation');

INSERT INTO `evaluation_formateur_criteres_notes` VALUES (1,15,'Compétence'),(1,20,'Disponibilité'),(1,15,'Façon d\'expliquer'),(1,15,'Gentillesse'),(1,20,'Maitrise du sujet');
